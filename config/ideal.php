...
$config['ideal_merchant_public_key'] = '';			// Path to the public certificate for the merchant
$config['ideal_merchant_private_key'] = '';			// Path to the private certificate for the merchant
$config['ideal_merchant_private_key_pass'] = '';	// Password for the private certificate

$config['ideal_issuer_public_key'] = '';			// Path to the public certificate for the issuer (bank)
